...
'New York' and 'Bengalaru'. The query returns 1, because total number of records
minus number of unique city names = 3 - 2 = 1.
*/

SELECT COUNT(CITY) - COUNT(DISTINCT CITY) STATE FROM STATION;