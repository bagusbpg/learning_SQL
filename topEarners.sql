...
employee_id INTEGER    employee's ID number
name        STRING     employee's name
months      INTEGER    total number of months employee has been working for the company
...
SELECT salary * months earnings, COUNT(employee_id)
FROM Employee
GROUP BY earnings
